...
link
	...
	"
	rel ="stylesheet "> /* Reset some default browser styles */ body {
	margin: 0;
	padding-top: 100px;
}
...
<script>
<% int span=Integer.parseInt(request.getAttribute("months")+"");%>
<% double emi=Double.parseDouble(""+request.getAttribute("EmiAmount"));%>
<% double la=Double.parseDouble(""+request.getAttribute("LoanAmount"));%>
    let currentTab = 0;
...
<body>
	...
	<div class="form-container">
		...
		<div class="form-box">
			...
			<div class="form-part" style="display: none;">
				<h2>Loan Details</h2>
				<b>Amount : </b> <input type="text" name="lnap_amount" value="<%=la %>"
					...
					Years : </b><br> <input type="text" name="lnap_noy" value="<%=span %>"
					placeholder="Enter No Of Years"><br> <b>Emi From
					Range : </b><br> <input type="tel" name="lnap_emi_range_from" value="<%=emi %>"
					placeholder="Enter Emi From Range"><br> <b>Emi to
					Range : </b> <input type="text" name="lnap_emi_range_to" value="<%=emi %>"
				...
				<button class="form-button"><a href="emischedule.jsp?amt=<%=emi%>&span=<%=span%>">Show</a></button>
